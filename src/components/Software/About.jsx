            ...
            <div className="col-lg-5">
              <div className="info">
                <div className="section-head long-shape mb-40 style-3">
                  <h3>RootXwire’s <span>Mission & Vision</span></h3>
                </div>
                <h5 className="h5">
                  “It is only when they go wrong that machines remind you how powerful they are.”
                </h5>
                <div className="text mb-20">
                  RootXwire Co is the partner of choice for many of the  leading enterprises, SMEs
                ...
                <div className="text mb-70">
                  RootXwire specializes in technological and IT-related services such as product
                  engineering, building cloud, etc.
                </div>
            ...
            <div className="col-lg-5">
              <div className="info pe-lg-5">
                <div className="section-head mb-40 style-3">
                  <h3>RootXwire’s <span>Technology</span></h3>
                </div>
