      ...
      <div className="container">
        <div className="row gx-0 justify-content-between">
          <div className="col-lg-3">
            <div className="items">
              <div className="title">
                RootXwire - 1st Choice for IT Solutions
              </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <small className="small">
                © 2022 Copyrights by <a href="#" className="fw-bold text-decoration-underline">RootXWire Co.</a> All Rights Reserved. Designed by <a href="#" className="fw-bold text-decoration-underline">RootXWire</a>
              </small>
            </div>
          </div>
